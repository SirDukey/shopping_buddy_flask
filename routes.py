...
from models import Product, Recipe, GroceryList
...
@main.route('/products/update/<int:product_id>', methods=['POST'])
...
@main.route('/grocery_list/update/quantity/<int:product_id>', methods=['POST'])
...
@main.route('/grocery_list/remove/product', methods=['POST'])
...
@main.route('/grocery_list/add/product/<int:product_id>', methods=['POST'])
...
@main.route('/grocery_list/add/recipe/<int:recipe_id>', methods=['POST'])
...
@main.route('/recipes/update/<int:recipe_id>', methods=['POST'])
